        ...
        <div className="min-h-screen">
            <div className="max-w-[65%] mx-auto p-6 flex flex-col gap-6">
                ...
                <div className="bg-black/50 border border-[#8E51FF80] rounded-xl p-6">
                    <h2 className="text-white text-[24px] font-medium mb-5">Profile Information</h2>
                    <ProfileInfoForm />
                </div>

                {/* Privacy */}
                <div className="bg-black/50 border border-[#8E51FF80] rounded-xl p-6">
                    <h2 className="text-white text-[24px] font-medium mb-5">Privacy & Data</h2>
                ...
                {/* Notification */}
                <div className="bg-black/50 border border-[#8E51FF80] rounded-xl p-6">
                    <h2 className="text-white text-[24px] font-medium mb-5">Notification</h2>
